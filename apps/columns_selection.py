...
def app():
    ...
    st.markdown('<h1 style="color: #5b61f9;">Select the Columns</h1>',
                                 unsafe_allow_html=True)
    ...
    #Dropping unused variables and updating the session state
