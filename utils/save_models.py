...
def save_model(model):
    ...
    save_path = w_dir + "/" + dir_name + "/" + time + "_" + st.session_state.model

    os.mkdir(save_path)

    model_path = save_path + "/" +st.session_state.model+"_"+time + "_Model"+".sav"
    ...
    name_of_file = st.session_state.model+"_"+time + "_Variables"+".txt"
